...
#db_handler.add_user_to_ticket(4,2)
...
# updaten username
# db_handler.update_user_username(1, "Remco")

# update user password
# db_handler.update_user_password(1, "01234567")

# update hours
#db_handler.update_ticket_hours(1,7)

# remove user 
#db_handler.remove_user(4)
